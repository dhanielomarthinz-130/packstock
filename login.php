...
<div class="min-h-screen bg-slate-950 flex items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans select-none">
  ...
  <div class="absolute -top-40 -left-40 w-[500px] h-[500px] bg-blue-500/15 rounded-full blur-[100px] pointer-events-none animate-pulse"></div>
  ...
  <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-blue-600/5 rounded-full blur-[120px] pointer-events-none"></div>
  ...
  <div class="w-full max-w-[880px] grid grid-cols-1 lg:grid-cols-12 rounded-[28px] sm:rounded-[36px] bg-slate-900/90 backdrop-blur-2xl border border-slate-800/90 shadow-2xl shadow-emerald-950/60 overflow-hidden relative z-10">
    ...
    <!-- ========================================================================= -->
    <div class="lg:col-span-5 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-950 p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden border-b lg:border-b-0 lg:border-r border-blue-600/20">
      ...
      <div class="space-y-4 relative z-10">
        <!-- Top Status Pill -->
        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-950/80 border border-blue-500/40 shadow-xs">
          <span class="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
          <span class="text-[10px] font-black tracking-wider uppercase text-blue-200">Enterprise WMS v2.4</span>
        </div>
      ...
      <div class="my-5 space-y-2.5 relative z-10">
        ...
        <div class="flex items-center gap-3 p-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.07] transition-colors">
          <div class="w-8 h-8 rounded-lg bg-emerald-500/20 text-blue-300 flex items-center justify-center shrink-0">
        ...
        <form id="loginForm" onsubmit="handleLoginSubmit(event)" class="space-y-4">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input type="text" id="username" required placeholder="Masukkan username akun Anda..." autocomplete="username"
                class="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-900 outline-none focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-500/10 transition-all placeholder:text-slate-400 placeholder:font-normal shadow-2xs">
            </div>
          </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input type="password" id="password" required placeholder="Masukkan kata sandi..." autocomplete="current-password"
                class="w-full pl-10 pr-11 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-900 outline-none focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-500/10 transition-all placeholder:text-slate-400 placeholder:font-normal shadow-2xs">
          ...
          <div class="flex items-center justify-between pt-0.5 text-xs">
            <label class="flex items-center gap-2 text-slate-600 font-medium cursor-pointer">
              <input type="checkbox" id="rememberMe" checked class="w-3.5 h-3.5 rounded border-slate-300 text-blue-600 focus:ring-blue-500">
          ...
          <div class="pt-2">
            <button type="submit" id="btnSubmit" 
              class="w-full py-3.5 px-5 bg-[#262363] hover:bg-[#1c1a4a] active:scale-[0.98] text-white font-bold text-xs rounded-xl shadow-lg shadow-[#262363]/25 hover:shadow-[#262363]/40 transition-all flex items-center justify-center gap-2 cursor-pointer">
              <span>Login</span>
